...
static bool append_nef(const CGAL_Nef_polyhedron& root_N, PLib3MFModelMeshObject *& model)
{
  ...
  PolySet ps{3, Geometry::Attributes{}}; //FIXME-MM properly export attributes instead of this
...
static bool append_3mf(const shared_ptr<const Geometry>& geom, PLib3MFModelMeshObject *& model)
{
  if (const auto geomlist = dynamic_pointer_cast<const GeometryList>(geom)) {
    ...
    PolySet triangulated(3, Geometry::Attributes{});  //FIXME-MM properly export attributes instead of this
